...
async def duplicate_flood_test():
    ...
    print(f"🚀 Starting duplicate flood test with delivery_id: dup-123")
    ...
    try:
        ...
        print(f"📡 Publishing 50 duplicate events to 'gh.pull_request.synchronize'...")
        ...
        print(f"✅ Successfully published all 50 duplicate events")
        print(f"🔄 Draining connection...")
        
        # Drain the connection
        await nc.drain()
        
        print(f"🎯 Expected behavior:")
        print(f"  - 1 workflow execution should be triggered")
        print(f"  - 49 duplicate events should be acknowledged and deduplicated")
        print(f"  - Check logs/metrics for deduplication confirmations")
