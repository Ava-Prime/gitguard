    ...
    for prereq in prerequisites:
        ...
        try:
            result = subprocess.run(
                prereq["check"].split(), capture_output=True, text=True, timeout=10, check=False
            )
            ...
            print("   Status: ❌ NOT FOUND - Command not available")
            all_ready = False
        except Exception as e:
...
def main():
    ...
    print("   Drill Explanation: ✅ PASS")
    print("   Execution Simulation: ✅ PASS")
