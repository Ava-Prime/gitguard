...
active_workflows = Gauge(
    "temporal_active_workflows", "Number of currently active workflows", ["workflow_type"]
)

active_activities = Gauge(
    "temporal_active_activities", "Number of currently active activities", ["activity_name"]
)
...
codex_docs_generated_total = Counter(
    "codex_docs_generated_total", "Total number of documentation pages generated", ["doc_type"]
)

codex_graph_updates_total = Counter(
    "codex_graph_updates_total", "Total number of knowledge graph updates", ["update_type"]
)
