...
class TestPRDigestEndpoint:
    ...
    def test_pr_digest_large_file_list_truncation(self, tmp_path, monkeypatch):
        ...
        payload = {"number": 101, "title": "Large refactor", "changed_paths": changed_paths}
...
class TestErrorHandling:
    ...
    def test_invalid_json_payload(self):
        ...
        response = client.post(
            "/codex/pr-digest", data="invalid json", headers={"Content-Type": "application/json"}
        )
