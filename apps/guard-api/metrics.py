...
api_request_duration_seconds = Histogram(
    'guard_api_request_duration_seconds',
...
codex_request_duration_seconds = Histogram(
    'guard_api_codex_request_duration_seconds',
    'Codex request duration in seconds',
    ['endpoint']
)
...
def record_webhook_event(event_type: str, action: str, success: bool = True, duration: Optional[float] = None) -> None:
    ...
    if duration is not None:
        webhook_processing_duration_seconds.labels(event_type=event_type, action=action).observe(duration)
